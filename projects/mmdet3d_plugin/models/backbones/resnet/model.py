...
class ResNetBackbone(nn.Module):
    def __init__(self, bkb_kwargs, fpn_kwargs=None, up_shape=None, ret_layers=1):
        super(ResNetBackbone, self).__init__()
        assert 0 < ret_layers < 4
        self.ret_layers = ret_layers
        self.bkb = ResNet(**bkb_kwargs)
        self.fpn = None if fpn_kwargs is None else BiFPN(**fpn_kwargs)
